      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-gray-300 mb-8 max-w-xl">
            I build and deploy modern full-stack web applications using React, Next.js, Node.js, PostgreSQL, and Prisma, with experience in scalable backend systems, performance optimization, and real-world product development.
          </p>
          ...
          <div className="flex flex-row gap-4 justify-center md:justify-start items-center">
            <motion.button
              ...
              className="px-5 py-2.5 md:px-7 md:py-3 border border-green-500 text-green-400 font-semibold rounded-lg hover:bg-green-500 hover:text-black transition"
            >
              View Projects
            </motion.button>
            ...
            <a
              ...
              className="px-5 py-2.5 md:px-7 md:py-3 bg-green-500 text-black font-semibold rounded-lg hover:bg-green-400 transition"
            >
              View Resume
            </a>
          </div>
